...
⚛️ React • 🅰️ Angular • NestJS • Express • Fastify • FastAPI • Flask • GraphQL • REST • WebSockets

**Databases & Messaging**

🍃 MongoDB • 🐘 PostgreSQL • 🔁 RabbitMQ • 🧠 Redis • ArangoDB • MySQL • MariaDB

**Cloud & DevOps**

🐳 Docker • ☸️ Kubernetes • ☁️ AWS (Lambda, S3, EKS) • GCP • GitHub Actions • Firebase • Supabase

**Other tooling**

Stripe • OAuth2 • Algolia • Socket.io • Swagger • Postman
